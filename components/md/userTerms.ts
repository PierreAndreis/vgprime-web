...
Welcome to VGPRO! We made this site because we’re COMMUNITY for COMMUNITY. We hope that you’ll enjoy taking part in our services and FREE entry competitions, contests, and using other applications, tools and services that we may provide from time to time.

  

BY USING THE SERVICES IN ANY WAY, REGISTERING FOR OR PARTICIPATING IN ANY COMPETITIONS, YOU:

(A) ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS AND CONDITIONS OF SERVICE AND ALL OBLIGATIONS AND RULES THAT MAY BE INCLUDED WITHIN EACH COMPETITION IN WHICH YOU PARTICIPATE (“Rules”) (these Terms and Conditions of Service, the terms of any policy incorporated herein, and the Rules are collectively referred to as the “Terms”) IN THEIR ENTIRETY;

(B) AGREE TO BE BOUND BY THE TERMS; AND

(C) ARE AUTHORIZED AND ABLE TO ACCEPT THESE TERMS. If you don’t wish to be bound by the Terms, do not click “I accept” and do not use the Services. Declining to accept these Terms means you will be unable to participate in Competitions or use your VGPRO account.
...
3.  **Service Availability.** The Company Service may be modified, updated, interrupted, suspended or discontinued at any time without notice or liability. If the Company Service were discontinued at any time, all data would be deleted pursuant to the discontinuation process.
    
4.  **Privacy Policy.** Use of the Company Service is subject to the terms of our Privacy Policy which is hereby incorporated into and made part of these Terms of Service. Please carefully review our Privacy Policy. By using or accessing the Company Service, you agree to be bound by the terms of our Privacy Policy.
...
8.  **Use of the Service.** You may wish to register to take advantage of certain features. If so, you agree to:
  <ol type="alpha">
    <li>
      provide true, accurate, current and complete information about yourself as prompted by the Company Service;
    </li>
    <li>
      as permitted, maintain and promptly update such information. If you provide any information that is false, inaccurate or outdated, or Company has reasonable grounds to suspect that such information is false, inaccurate or outdated, Company has the right to suspend or terminate your account and prohibit all current or future use of the Company Service by you; and
    </li>
    <li>
      as permitted, maintain and promptly update such information. If you provide any information that is false, inaccurate or outdated, or Company has reasonable grounds to suspect that such information is false, inaccurate or outdated, Company has the right to suspend or terminate your account and prohibit all current or future use of the Company Service by you; and
    </li>
  ...
  You may not do any of the following while accessing or using the Company Service:
    <ol type="alpha">
      <li>
        access, tamper with, or use non-public areas of the Company Service, our computer systems, or the technical delivery systems of our providers;
      </li>
      <li>
        probe, scan, or test the vulnerability of any system or network or breach or circumvent any security or authentication measures;
      </li>
      <li>
        access or search or attempt to access or search the Company Service by any means other than through our currently available, published interfaces that are provided by us, unless you have been specifically allowed to do so in a separate agreement with us;
      </li>
      <li>
        forge any TCP/IP packet header or any part of the header information in any email or posting, or in any way use the Company Service to send altered, deceptive or false source-identifying information; or
      </li>
      <li>
        disrupt or interfere with the access of any user, host or network, including, without limitation, sending a virus, overloading, flooding, spamming, mail-bombing the Company Service, or otherwise creating an undue burden on the Company Service.
      </li>
      <li>
        Engage in unfair methods in using the Software, including but not limited to, the opening and/or use of multiple accounts, the use of unauthorized or altered software or hardware to assist play (e.g., bots, bot-nets, and collusion with bots), intentionally poor play in certain games to achieve competitive advantage, collusion with other players.
      </li>
    </ol>
...
9.  **Fees.** Company Service does not come with Fees or Payments nor any billing application. All Competitions, and or Contests are free to participate.
    
10.  **Winnings.** If you are eligible to receive prize Winnings, we may require that you provide us with proof that you are, or were at the time of your participation in the subject Competition, eligible to participate in accordance with these Terms and that your participation was in accordance with these Terms. If you do not provide us with such proof to our reasonable satisfaction, then you will not receive the relevant Winnings. If you receive a Winnings in error, we may reverse or require return of the Winnings. You agree to cooperate with us in our efforts to do this. We may also reduce Prize awards to you without notice to adjust for any previous overpayment.
...
13.  **Termination.** You may terminate your use of the Company Service at any time. You agree that Company may terminate or suspend your access to all or part of the Company Service, with or without notice, in our reasonable discretion, at any time. Company reserves the right to modify or discontinue the Company Service (or any part thereof) with or without notice, at any time. Following the termination or cancellation of your subscription to the Company Service and/or your account, we reserve the right to delete all your data in the normal course of operations.
    
14.  **Representations.** You expressly represent, warrant, and/or acknowledge that:

  <ol type="alpha">
  <li>
  Company does not warrant or guarantee the suitability or availability of any Material or Content, including without limitation any, data, products or services, found through the Company Service.
  </li>
  <li>
  Company does not screen the authenticity or quality of any Material or Content or any provider of Material or Content, including, data, products or services found through the Company Service.
  </li>
  <li>
  Company makes no representations or promises regarding any Material or Content, and that many of the Material or Content provided via the Company Service may be owned or licensed by third parties.
  </li>
  <li>
  Neither Company, or its employees or officers, are financial professionals and make no financial representations or promises regarding any Material or Content posted to the Site, by any party.
  </li>
  <li>
  Neither Company, or its employees or officers, are healthcare professionals and make no healthcare representations or promises regarding any Material or Content posted to the Site, by any party.
  </li>
  <li>
  Company is not a party to any transaction between you and any provider of products or services via the Company Service. Any dispute shall be resolved between yourself and the provider of such products or services or your customer.
  </li>
  <li>
  Any information, including any data, Materials, or Content on the Company Service, including on any Facebook, Instagram or Twitter page, are for informational purposes only.
  </li>
  <li>
  You assume all risk when using the Company Service, including all the risks associated with any online or offline interactions with other users, providers of products and services, and from additional fees or charges from your mobile carrier.
  </li>
  <li>
...
17.  **Indemnification.** You agree to indemnify, defend and hold harmless the Company Parties against all claims, demands, causes of action, losses, expenses, damages and costs (including any reasonable attorneys’ fees), resulting or arising from or relating to your use of the Company Service, any activity related to your account by you or any other person permitted by you, any Content that you submit to, post on or transmit through the Company Service, your breach of these Terms of Service, your infringement or violation of any rights of another, or termination of your access to the Company Service. We reserve the right to assume, at our sole expense, the exclusive defense and control of any such claim or action and all negotiations for settlement or compromise, and you agree to fully cooperate with us in the defense of any such claim, action, settlement or compromise negotiations, as requested by us.
...
18.  **Procedure for Notifying the Company of Copyright Infringement.** Those who believe that their copyrighted work has been infringed or are aware of other infringing material, should contact our Copyright Agent at the address listed below and provide us with the following information:
  <ol type="alpha">
    ...
    <li>
    Information describing where the allegedly infringing material is located on the Company Service.
    </li>
    <li>
...
20.  **Applicable Law and Jurisdiction.** Your use of the Company Service is governed by and will be enforced under the laws of the State of Missouri without regard to its conflict of law provisions. You agree to submit to the personal and exclusive jurisdiction of the courts located within the State of Missouri. You agree that printed copies of any and all agreements and/or notices in electronic form are admissible in any legal or regulatory proceedings. Any controversy, claim, suit, injury or damage arising from or in any way related to the Company Service or these Terms of Service shall be settled by binding arbitration in accordance with the commercial arbitration rules of the American Arbitration Association then in effect and before a single arbitrator chosen by Company. Any such controversy, claim, suit, injury or damage shall be arbitrated on an individual basis and shall not be consolidated in any arbitration with any controversy, claim, suit, injury or damage of any other party. Company may seek any interim or preliminary relief from a court of competent jurisdiction in the State listed above necessary to protect its rights pending the completion of arbitration. Each party shall assume its own costs of arbitration. IN ANY CLAIM, ACTION OR PROCEEDING TO ENFORCE ANY RIGHT OR OBLIGATION OF THE PARTIES UNDER THE TERMS OF SERVICE INCLUDING, WITHOUT LIMITATION, RELATING TO YOUR USE OF THE COMPANY SERVICE, YOU HEREBY WAIVE ANY RIGHT YOU MAY NOW HAVE OR HEREAFTER POSSESS TO A TRIAL BY JURY.
  <ol type="alpha">
    <li>
    You acknowledge that various rules , regulations and laws address contests, and tournaments with prizes govern your participation in Competitions (“Gaming Laws”), and that Gaming Laws are set up by each individual US state, country, territory, or jurisdiction. Therefore, we DO NOT offer Cash Competitions in which a user has to purchase, and or buy-in to participate.
    </li>
    <li>
    It is your responsibility to determine whether the state, country, territory or jurisdiction in which you are located is a Prohibited Jurisdiction. We reserve the right (but have no obligation) to monitor the location from which you access Services, and we may block access from any Prohibited Jurisdiction. Each time you log into participate in a Prize Competition, you must accurately confirm the location from which you are playing when prompted by Company to do so.
    </li>
    <li>
    In addition to Gaming Laws, you are also subject to all municipal, state and federal laws, rules and regulations of the city, state, and country in which you reside from which you access and use Company Services, including without limitation U.S. export laws (together with Gaming Laws, the “Applicable Laws”. ) You are solely responsible for your compliance with all Applicable laws. Your participation in competitions is at your own risk, and you agree not to hold us responsible or liable if Applicable Laws restrict or prohibit your access or participation.
    </li>
    <li>
    LEGAL DISCLAIMERS. WE MAKE NO REPRESENTATIONS OR WARRANTIES, EXPRESS OR IMPLIED, AS TO THE LAWFULNESS OF YOUR PARTICIPATING IN ANY COMPETITION OR USE OF SERVICES, NOR SHALL ANY PERSON AFFILIATED, OR CLAIMING AFFILIATION, WITH US HAVE AUTHORITY TO MAKE ANY SUCH REPRESENTATIONS OR WARRANTIES.
    </li>
  </ol>
...
1.  If the FAQs do not provide an answer to Your query, the Customer Support Team would love to hear from You. Please reach out by sending us an email at [support@vgpro.gg](mailto:support@vgpro.gg) or filling out the ‘Contact Us’ form on the Q&A page with the following information:
...
3.  The Customer Support Team will endeavor to:
    

1.  Provide an initial response to Your query or complaint within seven (7) business days
    
2.  Investigate and attempt to resolve Your query within fourteen (14) business days or such longer period as necessary and notified to You by our team member.
`;
